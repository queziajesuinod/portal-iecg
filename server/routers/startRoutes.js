...
router.get('/celula/casais/sugestoes', (req, res) => CelulaController.sugerirCasais(req, res));
router.post('/celula/casais/vincular-lote', (req, res) => CelulaController.vincularCasaisEmLote(req, res));
router.post('/celula/casais/desvincular', (req, res) => CelulaController.desvincularCasal(req, res));
